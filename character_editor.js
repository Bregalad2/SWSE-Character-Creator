...
function pdfclick () {
    ...
    document.getElementById("special-actions").innerHTML = localStorage.getItem("special-actions");
}
...
function processhuman (currentspecies) {
    ...
    document.getElementById("bonus-feat").value = localStorage.getItem("special-actions").split(", ")[0]
    document.getElementById("bonus-feat").value = localStorage.getItem("special-actions").split(", ")[1]
}
function humansave () {
    localStorage.setItem("special-actions", document.getElementById("bonus-feat").value+", "+document.getElementById("bonus-feat2").value);
}
...
function changespecies() {
    ...
    if (currentspecies=="Near-Human") {
        ...
        localStorage.setItem("special-actions", "")
        specialactions = ""
        for (item in species[currentspecies]["species-traits"]["bonus-traits"]){
        ...
        localStorage.setItem("special-actions", specialactions)
    }
}
